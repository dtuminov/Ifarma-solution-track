...
@task
def parser_for_IRecommend(medication_urls: dict) -> pd.DataFrame:
    ...
    try:
        for drag_name, url in medication_urls.items():
            ...
            elements = WebDriverWait(driver, 10).until(
                EC.presence_of_all_elements_located((By.CSS_SELECTOR, 'div class="smTeaser woProduct plate reviews-list-item teaser-item tsr-processed tsr-viewed"'))
            )
